...
import { deleteKelompokPelajaran, fetchKelompokPelajaranPage, postExport, resetRedux } from '../slice/index'
...
const Table = () => {
  ...
  const onImport = () => {
    router.replace('/app/kelompok-pelajaran/import')
  }
  ...
  return (
    <Grid container spacing={6} sx={{ width: '100%' }}>
      <Grid size={12}>
        <Card>
          <CardHeader title='Kelompok Mata Pelajaran' sx={{ paddingBottom: 0 }} />
          <Toolbar
            sx={{
              px: '1.5rem !important',
              minHeight: 'auto',
