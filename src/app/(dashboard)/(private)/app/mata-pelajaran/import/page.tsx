...
export default function ImportExcelPage() {
  ...
  const handleConfirmCommit = async () => {
    ...
    .map(d => {
      const { nama_kelpelajaran, nama_lembaga, ...payload } = d.payload;
                ...
                >
                  ...
                  <div className="space-y-1">
                    ...
                    <div>
                      ...
                      <div>{row.payload.nama_kelpelajaran ?? '-'}</div>
                    </div>

                    <div>
                      <span className="text-gray-500">KKM</span>
                      <div>{row.payload.kkm ?? '0'}</div>
                    </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border p-6 space-y-6">
          <div className="border border-blue-200 bg-blue-50 rounded-lg p-4 text-sm text-blue-700">
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>Jika <b>kode_mapel</b> kosong → INSERT (data baru)</li>
              <li>Jika <b>kode_mapel</b> ada → UPDATE (perbarui data)</li>
