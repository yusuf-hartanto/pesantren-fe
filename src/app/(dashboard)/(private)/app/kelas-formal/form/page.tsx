...
import { fetchKelasFormalById, postKelasFormal, postKelasFormalUpdate, resetRedux } from '../slice/index'
...
const FormValidationBasic = () => {
  ...
  const storeLembaga = useAppSelector(state => state.lembaga_formal)
  ...
  useEffect(() => {
    ...
    if (id) {
      dispatch(fetchKelasFormalById(id)).then(res => {
