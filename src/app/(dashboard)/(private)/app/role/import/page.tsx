...
import { postBatchRole, postExport, postImport, resetRedux } from '../slice'
...
export default function ImportExcelPage() {
  ...
  const handleConfirmCommit = async () => {
    ...
    try {
      ...
      const res = await dispatch(postBatchRole({ data: payloads })).unwrap()
              ...
              {result.data.map((row) => (
                ...
                >
                  ...
                  <div className="space-y-1">
                    <div>
                      <span className="text-gray-500">Nama Role</span>
                      <div className="font-medium">
                        {row.payload.role_name}
                      </div>
                    </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border p-6 space-y-6">
          <div className="border border-blue-200 bg-blue-50 rounded-lg p-4 text-sm text-blue-700">
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>Jika <b>nama_role</b> kosong → INSERT (data baru)</li>
              <li>Jika <b>nama_role</b> ada → UPDATE (perbarui data)</li>
