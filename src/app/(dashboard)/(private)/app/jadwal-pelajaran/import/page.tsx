            ...
            <tbody>
              {result.data.map(row => (
                <tr key={row.row} className={row.valid ? 'border-t bg-white' : 'border-t bg-red-50'}>
                  ...
                  <td className='px-3 py-2 font-medium'>{row.payload.jam}</td>
                  <td className='px-3 py-2 font-medium'>{row.payload.kelas}</td>
                  <td className='px-3 py-2 font-medium'>{row.payload.mapel}</td>
                  <td className='px-3 py-2 font-medium'>{row.payload.guru}</td>
                  <td className='px-3 py-2 font-medium'>{row.payload.lokasi}</td>
