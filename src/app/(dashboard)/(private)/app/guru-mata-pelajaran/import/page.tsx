...
export default function ImportExcelPage() {
  ...
  const handleConfirmCommit = async () => {
    ...
    .map(d => {
      const { nama_guru, nama_mapel, nama_lembaga, nama_tingkat, ...payload } = d.payload;
                  ...
                  <div className="space-y-1">
                    <div>
                      ...
                      <div className="font-medium">
                        {row.payload.nama_guru}
                      </div>
                    </div>

                    <div>
                      <span className="text-gray-500">Mapel</span>
                      <div>{row.payload.nama_mapel ?? '-'}</div>
                    </div>
                    ...
                    <div>
                      ...
                      <div>{row.payload.nama_tingkat ?? '0'}</div>
                    </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10 px-4">
      <div className="mx-auto">
        <div className="mb-6">
          <Link
            href="/app/guru-mata-pelajaran/list"
        ...
        <div className="bg-white rounded-xl shadow-sm border p-6 space-y-6">
          <div className="border border-blue-200 bg-blue-50 rounded-lg p-4 text-sm text-blue-700">
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>Jika <b>nama_guru</b> kosong → INSERT (data baru)</li>
              <li>Jika <b>nama_guru</b> ada → UPDATE (perbarui data)</li>
