...
// ** Store & Actions
import { getDataTingkat, getTingkat } from '../store/action'
    ...
    <div className='invoice-list-table-header w-100 mr-1 ml-50 mt-2 mb-75'>
      <Row>
        ...
        >
          ...
          {ability.can('create', 'tingkat') &&
            <Link to='/tingkat/save' onClick={handleCreate}>
