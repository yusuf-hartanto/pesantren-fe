...
// ** Store & Actions
import { getDataGlobalParam, getGlobalParam } from '../store/action'
    ...
    <div className='invoice-list-table-header w-100 mr-1 ml-50 mt-2 mb-75'>
      <Row>
        ...
        >
          ...
          {ability.can('create', 'global_param') &&
            <Link to='/global_param/save' onClick={handleCreate}>
...
const ClassList = () => {
  ...
  useEffect(() => {
    if (!store.params) {
      ...
      dispatch(
        getDataGlobalParam(store.params)
      )
