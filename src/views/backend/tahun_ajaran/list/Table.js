...
// ** Store & Actions
import { getDataTahunAjaran, getTahunAjaran } from '../store/action'
    ...
    <div className='invoice-list-table-header w-100 mr-1 ml-50 mt-2 mb-75'>
      <Row>
        ...
        >
          ...
          {ability.can('create', 'tahun_ajaran') &&
            <Link to='/tahun_ajaran/save' onClick={handleCreate}>
...
const ClassList = () => {
  ...
  useEffect(() => {
    if (!store.params) {
      ...
      dispatch(
        getDataTahunAjaran(store.params)
      )
