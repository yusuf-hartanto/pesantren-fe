...
// ** Store & Actions
import { getDataBawasluUpdate, getBawasluUpdate } from '../store/action'
    ...
    <div className='invoice-list-table-header w-100 mr-1 ml-50 mt-2 mb-75'>
      <Row>
        ...
        >
          ...
          {ability.can('create', 'bawaslu_update') &&
            <Link to='/bawaslu_update/save' onClick={handleCreate}>
...
const ClassList = () => {
  ...
  useEffect(() => {
    if (!store.params) {
      ...
      dispatch(
        getDataBawasluUpdate(store.params)
      )
  ...
  const handleCreate = e => {
    dispatch(getBawasluUpdate(null))
  }
