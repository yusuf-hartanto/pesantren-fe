...
// ** Store & Actions
import { getDataTahunAngkatan, getTahunAngkatan } from '../store/action'
    ...
    <div className='invoice-list-table-header w-100 mr-1 ml-50 mt-2 mb-75'>
      <Row>
        ...
        >
          ...
          {ability.can('create', 'tahun_angkatan') &&
            <Link to='/tahun_angkatan/save' onClick={handleCreate}>
...
const ClassList = () => {
  ...
  useEffect(() => {
    if (!store.params) {
      ...
      dispatch(
        getDataTahunAngkatan(store.params)
      )
  ...
  const handleCreate = e => {
    dispatch(getTahunAngkatan(null))
  }
