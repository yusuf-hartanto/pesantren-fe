...
// ** Store & Actions
import { getDataStatusAwalSantri, getStatusAwalSantri } from '../store/action'
    ...
    <div className='invoice-list-table-header w-100 mr-1 ml-50 mt-2 mb-75'>
      <Row>
        ...
        >
          ...
          {ability.can('create', 'status_awal_santri') &&
            <Link to='/status_awal_santri/save' onClick={handleCreate}>
...
const ClassList = () => {
  ...
  useEffect(() => {
    if (!store.params) {
      ...
      dispatch(
        getDataStatusAwalSantri(store.params)
      )
  ...
  const handleCreate = e => {
    dispatch(getStatusAwalSantri(null))
  }
